...
public class Main {
    ...
    public static void main(String[] args){
     //   open(null);
    	File sourceimage = new File("D:\\eclipseWorkSpace\\morph\\oneIM-10086-0002.png");
    	File sourceimage2 = new File("D:\\eclipseWorkSpace\\morph\\twoIM-10086-0006.png");
    	Image image1=null;
    	Image image2=null;
                            ...
                            new Thread(){
                                public void run(){
                                    ...
                                    for (int j = 0; j < images.size(); j++) {
										BufferedImage t=(BufferedImage) images.get(j);
										File img=new File("s"+j+".png");
										try {
											ImageIO.write(t, "png", img);
										} catch (IOException e) {
											// TODO Auto-generated catch block
											e.printStackTrace();
										}
    ...
    public static void morph(Image one, Image two, int frames){
    	ImageView onee=new ImageView(one, "");
    	ImageView twoo=new ImageView(two, "");
    	
        ArrayList<Image> images = new ArrayList<Image>(frames);

        Mesh fromMesh = onee.mesh;
        Mesh toMesh = twoo.mesh;
        Image[] results = Morpher.morph(one, fromMesh, two, toMesh, frames, "");
        for(Image im : results)
            images.add(im);
